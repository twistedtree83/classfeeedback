...
-- Create policies
CREATE POLICY "Allow public insert to extension_requests"
  ON extension_requests
  FOR INSERT TO public
  WITH CHECK (true);

CREATE POLICY "Allow public select on extension_requests"
  ON extension_requests
  FOR SELECT TO public
  USING (true);

CREATE POLICY "Allow public update on extension_requests"
  ON extension_requests
